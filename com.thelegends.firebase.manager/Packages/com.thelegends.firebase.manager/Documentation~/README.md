# com.thelegends.firebase.manager


A com.thelegends.firebase.manager package for the [Unity](https://unity.com/) Game Engine.
...
- Add the `com.thelegends.firebase.manager` package
